...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/spreadsheet.ts [app-ssr] (ecmascript)"); // Added createEmptyCell and getCellId
"use client";
;
;
;
...
function SpreadsheetProvider({ children }) {
    const [internalSpreadsheet, setInternalSpreadsheet] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const setSpreadsheetWithHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((updater, actionSource)=>{
        setInternalSpreadsheet((current)=>{
    ...
    const saveSpreadsheet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveSpreadsheet"])(updatedSpreadsheet);
        if (result.success) {
    ...
    const updateCell = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((sheetId, rowIndex, colIndex, newCellData)=>{
        setSpreadsheetWithHistory((prevSpreadsheet)=>{
            ...
            const newSheets = prevSpreadsheet.sheets.map((sheet)=>{
                if (sheet.id === sheetId) {
                    const newCells = sheet.cells.map((row, rIdx)=>{
                        if (rIdx === rowIndex) {
    ...
    const insertRow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((sheetId, rowIndex)=>{
        setSpreadsheetWithHistory((prevSpreadsheet)=>{
            if (!prevSpreadsheet) return null;
            const newSheets = prevSpreadsheet.sheets.map((sheet)=>{
                if (sheet.id === sheetId) {
                    ...
                    }, (_, cIdx)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createEmptyCell"])(rowIndex, cIdx));
                    const updatedCells = [
                        ...sheet.cells
                    ];
                    ...
                    for(let r = rowIndex; r < updatedCells.length; r++){
                        for(let c = 0; c < updatedCells[r].length; c++){
                            updatedCells[r][c].id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCellId"])(r, c);
                        }
                    }
                    return {
                        ...sheet,
    ...
    const deleteRow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((sheetId, rowIndex)=>{
        setSpreadsheetWithHistory((prevSpreadsheet)=>{
            if (!prevSpreadsheet) return null;
            const newSheets = prevSpreadsheet.sheets.map((sheet)=>{
                if (sheet.id === sheetId) {
            ...
            if (prevSpreadsheet.sheets.find((s)=>s.id === sheetId)?.rowCount ?? 0 > 1) {
                toast({
                    title: "Row Deleted",
    ...
    const insertColumn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((sheetId, colIndex)=>{
        setSpreadsheetWithHistory((prevSpreadsheet)=>{
            if (!prevSpreadsheet) return null;
            const newSheets = prevSpreadsheet.sheets.map((sheet)=>{
                if (sheet.id === sheetId) {
                    const updatedCells = sheet.cells.map((row, rIdx)=>{
                        const newRow = [
                            ...row
                        ];
                        newRow.splice(colIndex, 0, (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createEmptyCell"])(rIdx, colIndex));
                        return newRow;
                    });
            ...
            toast({
                ...
                description: `Column inserted at index ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCellId"])(0, colIndex).replace(/[0-9]/g, '')}.`
            });
            return {
                ...prevSpreadsheet,
                sheets: newSheets,
    ...
    const deleteColumn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((sheetId, colIndex)=>{
        setSpreadsheetWithHistory((prevSpreadsheet)=>{
            if (!prevSpreadsheet) return null;
            const newSheets = prevSpreadsheet.sheets.map((sheet)=>{
                if (sheet.id === sheetId) {
            ...
            if (prevSpreadsheet.sheets.find((s)=>s.id === sheetId)?.columnCount ?? 0 > 1) {
                toast({
                    title: "Column Deleted",
                    description: `Column ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCellId"])(0, colIndex).replace(/[0-9]/g, '')} deleted.`
                });
            }
            return {
                ...prevSpreadsheet,
    ...
    const undo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (undoStack.length > 0) {
            ...
            setSpreadsheetWithHistory(()=>previousState, 'undo');
            setSelectedCell(null);
            toast({
                title: "Undo",
    ...
    const redo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (redoStack.length > 0) {
            ...
            setSpreadsheetWithHistory(()=>nextState, 'redo');
            setSelectedCell(null);
            toast({
                title: "Redo",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$save$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Save$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/save.js [app-ssr] (ecmascript) <export default as Save>"); // Added Trash2, RowsIcon, Columns
...
function Toolbar({ spreadsheetName }) {
    const { saveSpreadsheet, spreadsheet, setSpreadsheet, selectedCell, updateSelectedCellStyle, insertRow, deleteRow, insertColumn, deleteColumn, undo, redo, canUndo, canRedo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
    ...
    const selectedCellStyle = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useMemo(()=>{
        ...
        const sheet = spreadsheet.sheets.find((s)=>s.id === selectedCell.sheetId);
        if (!sheet) return {};
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                        ...
                        disabled: !spreadsheet,
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$rows$2d$2$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__RowsIcon$3e$__["RowsIcon"], {}, void 0, false, {
                            fileName: "[project]/src/components/spreadsheet/Toolbar.tsx",
                            lineNumber: 189,
                            columnNumber: 150
                        }, this)
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                        ...
                        disabled: !spreadsheet,
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$columns$2d$2$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Columns$3e$__["Columns"], {}, void 0, false, {
                            fileName: "[project]/src/components/spreadsheet/Toolbar.tsx",
                            lineNumber: 191,
                            columnNumber: 157
                        }, this)
...
function Cell({ cellData, rowIndex, colIndex, onCellChange, sheetId, isSelected, onSelect }) {
    ...
    if (isEditing) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("p-0 border relative", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("p-1.5 border cursor-cell text-sm truncate min-w-[100px] relative", {
        ...
        "aria-readonly": true,
        children: [
            isSelected && !isEditing && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function Grid({ sheet }) {
    const { updateCell, selectedCell, setSelectedCell } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/button.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useSpreadsheet.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/spreadsheet.ts [app-ssr] (ecmascript)"); // Import getCellId
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/check.js [app-ssr] (ecmascript) <export default as Check>"); // Added icons
...
;
function FormulaBar() {
    const { spreadsheet, selectedCell, updateCell } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
    ...
    const [isEditingFormula, setIsEditingFormula] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // To show/hide cancel/confirm buttons
    ...
    const selectedCellName = selectedCell && spreadsheet ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCellId"])(selectedCell.rowIndex, selectedCell.colIndex) : ' '; // Display space if no cell is selected
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6080c4a5._.js.map