...
function SpreadsheetProvider({ children }) {
    const [spreadsheet, setSpreadsheet] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const saveSpreadsheet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        if (result.success) {
            setSpreadsheet(updatedSpreadsheet); // Ensure local state has updatedAt
            toast({
                title: "Success",
                    ...
                    const newCells = sheet.cells.map((row, rIdx)=>{
                        if (rIdx === rowIndex) {
                            return row.map((cell, cIdx)=>{
                                if (cIdx === colIndex) {
                                    // Basic formula check (very simplified)
                                    let value = newCellData.rawValue;
                                    if (typeof newCellData.rawValue === 'string' && newCellData.rawValue.startsWith('=')) {
                                        // TODO: Implement actual formula parsing and calculation engine here
                                        // For now, just display the formula string as value or a placeholder
...
function Toolbar({ spreadsheetName }) {
    const { saveSpreadsheet, spreadsheet, setSpreadsheet } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
    ...
    const handleExport = (format)=>console.log(`Export as ${format}`);
    const handleLoadFromFile = ()=>console.log("Load from file");
    ...
    // More formatting functions would go here
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-2 border-b bg-card flex items-center justify-between gap-2 shadow-sm flex-wrap",
        children: [
...
;
;
function Cell({ cellData, rowIndex, colIndex, onCellChange }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Update editValue if cellData.rawValue changes from outside (e.g. formula update)
    ...
    const handleBlur = (e)=>{
        // Check if the new target is part of the same cell or its controls
        // to prevent blur when, for example, clicking a format button for this cell.
        // This is a basic check; more robust focus management might be needed.
        if (e.relatedTarget && e.currentTarget.contains(e.relatedTarget)) {
            return;
        }
        setIsEditing(false);
        if (editValue !== cellData.rawValue) {
    ...
    const handleKeyDown = (e)=>{
        if (e.key === 'Enter') {
            setIsEditing(false);
            // The blur handler will take care of saving the value
            e.target.blur(); // Trigger blur to save
        } else if (e.key === 'Escape') {
            setEditValue(cellData.rawValue || ''); // Revert to original value
            setIsEditing(false);
    ...
    if (isEditing) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Input"], {
                ...
                className: "w-full h-full p-1.5 box-border border-2 border-primary focus:ring-0 focus:border-primary text-sm outline-none rounded-none",
                style: appliedStyle,
                autoFocus: true,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("p-1.5 border cursor-cell text-sm truncate min-w-[100px]", // Add classes for alignment, etc. based on cellData.style
        {
        ...
        }, // Tailwind classes for text alignment if available in theme or custom
        ...
        onFocus: ()=>{},
        "aria-readonly": true,
        children: cellData.value !== undefined && cellData.value !== null ? String(cellData.value) : ''
    }, void 0, false, {
        fileName: "[project]/src/components/spreadsheet/Cell.tsx",
        lineNumber: 91,
        columnNumber: 5
...
;
;
// Helper to generate column names (A, B, ..., Z, AA, AB, ...)
...
function Grid({ sheet }) {
    const { updateCell } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
    const handleCellChange = (rowIndex, colIndex, rawValue)=>{
        updateCell(sheet.id, rowIndex, colIndex, {
            rawValue
        });
    };
    // Virtualization is needed for large sheets. This is a simple render.
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$scroll$2d$area$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ScrollArea"], {
        className: "h-full w-full p-1 bg-muted/20",
        children: [
                ...
                children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableRow"], {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableHead"], {
                                    className: "w-12 min-w-[3rem] p-0 text-center border sticky left-0 bg-card z-20",
                                    children: "#"
                                }, void 0, false, {
                                ...
                                Array.from({
                                    length: sheet.columnCount
                                        ...
                                        className: "min-w-[100px] p-0 text-center border",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableBody"], {
                        children: sheet.cells.map((row, rowIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableRow"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableHead"], {
                                        className: "w-12 min-w-[3rem] p-0 text-center border sticky left-0 bg-card z-10",
                                        children: rowIndex + 1
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/spreadsheet/Grid.tsx",
                                        lineNumber: 49,
...
;
function FormulaBar() {
    const [formula, setFormula] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const { spreadsheet, updateCell } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ResizablePanelGroup, {
                    direction: "vertical",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ResizablePanel, {
                        defaultSize: 100,
...
function SpreadsheetEditorPageContents() {
    ...
    const { spreadsheet, isLoading, loadSpreadsheet } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$SpreadsheetContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0ec80a31._.js.map