...
function SpreadsheetProvider({ children }) {
    ...
    const loadSpreadsheet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (id)=>{
        ...
        if (result.success && result.data) {
            // Ensure columnWidths exists on loaded sheets
            const loadedSpreadsheet = result.data;
            loadedSpreadsheet.sheets = loadedSpreadsheet.sheets.map((sheet)=>({
                    ...sheet,
                    columnWidths: sheet.columnWidths || Array(sheet.columnCount).fill(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"])
                }));
            exposedSetSpreadsheet(loadedSpreadsheet);
        } else {
                        ...
                        if (rIdx === rowIndex) {
                            return row.map((cell, cIdx)=>{
                                if (cIdx === colIndex) {
                                    ...
                                    let formulaString = cell.formula;
                                    if (newCellData.rawValue !== undefined) {
                                        if (typeof newCellData.rawValue === 'string' && newCellData.rawValue.startsWith('=')) {
                                            ...
                                            valueToDisplay = newCellData.rawValue;
                                        } else {
            ...
            const newSheets = prevSpreadsheet.sheets.map((sheet)=>{
                if (sheet.id === sheetId) {
                    ...
                    const newColumnWidths = [
                        ...sheet.columnWidths || Array(sheet.columnCount).fill(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"])
                    ];
                    newColumnWidths.splice(colIndex, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"]);
                    return {
                        ...sheet,
                        cells: updatedCells,
    ...
    const appendRow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((sheetId)=>{
        setSpreadsheetWithHistory((prevSpreadsheet)=>{
            if (!prevSpreadsheet) return null;
            const newSheets = prevSpreadsheet.sheets.map((sheet)=>{
                if (sheet.id === sheetId) {
                    const newRowIndex = sheet.rowCount;
                    const newRow = Array.from({
                        length: sheet.columnCount
                    }, (_, cIdx)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createEmptyCell"])(newRowIndex, cIdx));
                    const updatedCells = [
                        ...sheet.cells,
                        newRow
                    ];
    ...
    const appendColumn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((sheetId)=>{
        setSpreadsheetWithHistory((prevSpreadsheet)=>{
            if (!prevSpreadsheet) return null;
            const newSheets = prevSpreadsheet.sheets.map((sheet)=>{
                if (sheet.id === sheetId) {
                    const newColIndex = sheet.columnCount;
                    const updatedCells = sheet.cells.map((row, rIdx)=>[
                            ...row,
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createEmptyCell"])(rIdx, newColIndex)
                        ]);
                    const newColumnWidths = [
                        ...sheet.columnWidths || Array(sheet.columnCount).fill(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"]),
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"]
                    ];
                    toast({
                        title: "Column Added",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$square$2d$minus$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MinusSquare$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/square-minus.js [app-ssr] (ecmascript) <export default as MinusSquare>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$spreadsheet$2f$AvailableFunctionsDialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/spreadsheet/AvailableFunctionsDialog.tsx [app-ssr] (ecmascript)"); // Import the new dialog
"use client";
;
;
;
...
function Toolbar({ spreadsheetName, theme, setTheme }) {
    const { saveSpreadsheet, spreadsheet, setSpreadsheet: setContextSpreadsheet, selectedCell, updateSelectedCellStyle, insertRow, deleteRow, insertColumn, deleteColumn, appendRow, appendColumn, undo, redo, canUndo, canRedo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                        ...
                        title: "Delete Row",
                        disabled: !selectedCell,
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$square$2d$minus$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MinusSquare$3e$__["MinusSquare"], {}, void 0, false, {
                            fileName: "[project]/src/components/spreadsheet/Toolbar.tsx",
                            lineNumber: 213,
                            columnNumber: 139
                        }, this)
...
;
;
function Cell({ cellData, rowIndex, colIndex, onCellChange, sheetId, isSelected, onSelect, width }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("p-1.5 border cursor-cell text-sm truncate min-w-[var(--default-cell-width,120px)] relative", {
                            ...
                            children: [
                                ...
                                Array.from({
                                    length: sheet.columnCount
                                        ...
                                        className: "p-0 text-center border select-none",
                                        style: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__67f08812._.js.map