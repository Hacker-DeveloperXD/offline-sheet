...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/spreadsheet.ts [app-ssr] (ecmascript)"); // Renamed to avoid conflict
...
actualEvaluateFormulaLogic = (currentSpreadsheetData, sheetId, formulaExpressionWithEquals, visitedCellsInCurrentChain)=>{
    ...
    if (topLevelFunctionMatch) {
        ...
        let firstErrorInFlatValues = null;
    ...
    const customFunctionsForMathJS = {
        SUM: (...args)=>{
            ...
            let firstError = null;
            const nums = flatArgs.reduce((acc, val)=>{
                if (val && typeof val === 'object' && val.isMatrix === true) {
                    val.toArray().flat(Infinity).forEach((mVal)=>{
                        if (typeof mVal === 'number' && isFinite(mVal)) acc.push(mVal);
                        else if (typeof mVal === 'string' && mVal.startsWith('#')) {
                            if (!firstError) firstError = mVal;
                        }
                    });
        ...
        COUNT: (...args)=>{
            const flatArgs = args.flat(Infinity);
            let firstError = null; // COUNT should ignore errors and count numbers
            const nums = flatArgs.reduce((acc, val)=>{
                if (val && typeof val === 'object' && val.isMatrix === true) {
                    val.toArray().flat(Infinity).forEach((mVal)=>{
                        if (typeof mVal === 'number' && isFinite(mVal)) acc.push(mVal);
...
const reevaluateSheetFormulas = (spreadsheetData, sheetToReevaluateId)=>{
    const updatedSpreadsheet = JSON.parse(JSON.stringify(spreadsheetData)); // Deep clone
    ...
    if (sheetToUpdate) {
        ...
        for(let r = 0; r < sheetToUpdate.rowCount; r++){
            for(let c = 0; c < sheetToUpdate.columnCount; c++){
                ...
                if (!sheetToUpdate.cells[r][c]) sheetToUpdate.cells[r][c] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createEmptyCell"])(r, c); // Ensure cell exists
        ...
        cellsToUpdate.forEach((pos)=>{
            ...
            cell.formula = cell.rawValue; // We know it starts with =
...
function SpreadsheetProvider({ children }) {
    ...
    const [isActivelyEditingFormula, setIsActivelyEditingFormulaState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const setIsActivelyEditingFormula = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((isEditing)=>{
    ...
    const setSpreadsheetWithHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((updater, actionSource)=>{
        setInternalSpreadsheetState((current)=>{
            ...
            if (newSpreadsheet && actionSource !== 'reeval') {
                newSpreadsheet.sheets.forEach((sheet)=>{
                    newSpreadsheet = reevaluateSheetFormulas(newSpreadsheet, sheet.id);
                });
            }
            if (actionSource !== 'undo' && actionSource !== 'redo' && actionSource !== 'internal_no_history' && actionSource !== 'save' && actionSource !== 'reeval' && currentDeepCloneForHistory && newSpreadsheet && JSON.stringify(currentDeepCloneForHistory) !== JSON.stringify(newSpreadsheet)) {
                setUndoStack((prev)=>[
    ...
    const setActiveCellAndSelection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((newCellAddress, isShiftKey, isDrag, endAddressOverrideForDrag)=>{
    ...
    const formatSelectionAsTable = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        ...
        setSpreadsheetWithHistory((prevSpreadsheet)=>{
            ...
            setTimeout(()=>toast({
                    ...
                    description: "Selected range formatted as a basic table."
                }), 0);
            return spreadsheetCopy;
        });
    }, [
        ...
        setSpreadsheetWithHistory((prevSpreadsheet)=>{
            ...
            switch(operation){
                ...
                case 'insertColumn':
                    ...
                    sheet.columnWidths = sheet.columnWidths || Array(sheet.columnCount).fill(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"]);
                    if (sheet.columnWidths.length < updateColCount + 1) {
                        sheet.columnWidths = [
                            ...sheet.columnWidths,
                            ...Array(updateColCount + 1 - sheet.columnWidths.length).fill(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"])
                        ];
                    }
                    sheet.columnWidths.splice(index, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"]);
                    updateColCount++;
                    toastInfo = {
                ...
                case 'appendColumn':
                    ...
                    sheet.columnWidths = sheet.columnWidths || Array(sheet.columnCount).fill(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"]);
                    sheet.columnWidths.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"]);
                    updateColCount++;
                    toastInfo = {
                        title: "Column Added",
    ...
    const copySelectionToClipboard = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        for(let r = minRow; r <= maxRow; r++){
            for(let c = minCol; c <= maxCol; c++){
                ...
                const valueToCopy = cell?.value === '' && (cell?.rawValue === '' || cell?.rawValue === null || cell?.rawValue === undefined) ? '' : cell?.rawValue?.toString() ?? "";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/dialog.tsx [app-ssr] (ecmascript)"); // For placeholder dialogs
"use client";
;
;
;
...
function Toolbar({ spreadsheetName, theme, setTheme }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Dialog"], {
                open: isConditionalFormattingDialogOpen,
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogHeader"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                    children: "This feature allows you to apply formatting to cells based on certain rules or conditions. Full implementation is coming soon!"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/spreadsheet/Toolbar.tsx",
                                    lineNumber: 339,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogFooter"], {
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                onClick: ()=>setIsConditionalFormattingDialogOpen(false),
                                children: "Close"
                            }, void 0, false, {
                                fileName: "[project]/src/components/spreadsheet/Toolbar.tsx",
                                lineNumber: 345,
...
;
;
function Cell({ cellData, address, onCellChange, isActive, isInSelectionRange, isFormulaHighlightTarget, onSelect, startEditing, stopEditing, isEditingThisCell, width, isActivelyEditingFormulaGlobal }) {
    ...
    const cellClasses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("p-1.5 border text-sm truncate min-w-[var(--default-cell-width,120px)] relative select-none outline-none", // Base styling
    {
    ...
    }, cellData.style?.textAlign === 'left' && "text-left", cellData.style?.textAlign === 'center' && "text-center", cellData.style?.textAlign === 'right' && "text-right", // Conditional styling for selection states
    // Normal selection range (not the primary active cell, and not formula editing)
    isInSelectionRange && !isActive && !isActivelyEditingFormulaGlobal && "bg-primary/20", // Formula highlight target (has precedence over isInSelectionRange if both true)
    ...
    if (isEditingThisCell && !isActivelyEditingFormulaGlobal) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])(cellClasses, "p-0 z-10"),
            style: {
                ...appliedStyle,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
        ...
        children: [
            ...
            isFormulaHighlightTarget && !isActive && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute inset-[-1px] border border-dashed border-green-700 pointer-events-none rounded-[1px] z-10"
            }, void 0, false, {
                fileName: "[project]/src/components/spreadsheet/Cell.tsx",
                lineNumber: 229,
                columnNumber: 10
...
function Grid({ sheet }) {
    const { spreadsheet, updateCell, activeCell, selectionRange, setActiveCellAndSelection, isActivelyEditingFormula, formulaBarApiRef } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
    ...
    const isMouseDownRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(false); // To track mouse button state globally for drag
    ...
    const handleGridMouseLeave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const handleClickOutside = (event)=>{
            if (gridRef.current && !gridRef.current.contains(event.target) && editingCell) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f8048416._.js.map