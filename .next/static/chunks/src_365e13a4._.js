(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_365e13a4._.js", {
...
function reevaluateSheetFormulas(spreadsheetData, sheetToReevaluateId) {
    ...
    if (sheetToUpdate) {
        for(let r = 0; r < sheetToUpdate.rowCount; r++){
            ...
            }, (_, c)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEmptyCell"])(r, c));
...
function SpreadsheetProvider({ children }) {
    ...
    const [lastFoundCell, setLastFoundCell] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [isActivelyEditingFormula, setIsActivelyEditingFormula] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
            ...
            if (result.success && result.data) {
                ...
                loadedSpreadsheet.sheets = loadedSpreadsheet.sheets.map({
                    "SpreadsheetProvider.useCallback[loadSpreadsheet]": (sheet_from_db)=>{
                        ...
                        (currentProcessingSheet.mergedCells || []).forEach({
                            "SpreadsheetProvider.useCallback[loadSpreadsheet]": (mergeRange)=>{
        ...
        "SpreadsheetProvider.useCallback[setActiveCellAndSelection]": (newCellAddress, isShiftKey, isDrag)=>{
            ...
            if (newCellAddress && internalSpreadsheetRef.current) {
                ...
                if (sheet) {
                    ...
                    const mergedRange = (sheet.mergedCells || []).find({
                        "SpreadsheetProvider.useCallback[setActiveCellAndSelection].mergedRange": (mr)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCellAddressInRange"])(masterAddress, mr)
                    }["SpreadsheetProvider.useCallback[setActiveCellAndSelection].mergedRange"]);
                    if (mergedRange) {
                        finalActiveCell = {
                            sheetId: sheet.id,
                ...
                "SpreadsheetProvider.useCallback[modifySheetStructure]": (prevSpreadsheet)=>{
                    ...
                    switch(operation){
                        case 'insertRow':
                            ...
                            if (sheet.mergedCells) {
                                sheet.mergedCells = sheet.mergedCells.map({
                                    "SpreadsheetProvider.useCallback[modifySheetStructure]": (mc)=>{
                        ...
                        case 'deleteRow':
                            ...
                            if (sheet.mergedCells) {
                                sheet.mergedCells = sheet.mergedCells.filter({
                                    "SpreadsheetProvider.useCallback[modifySheetStructure]": (mc)=>!(mc.start.rowIndex === index && mc.end.rowIndex === index)
                                }["SpreadsheetProvider.useCallback[modifySheetStructure]"]) // Remove merges fully within deleted row
                                .map({
                                    "SpreadsheetProvider.useCallback[modifySheetStructure]": (mc)=>{
                                        if (mc.start.rowIndex > index) mc.start.rowIndex--;
                                ...
                                }["SpreadsheetProvider.useCallback[modifySheetStructure]"]).filter({
                                    "SpreadsheetProvider.useCallback[modifySheetStructure]": (mc)=>mc.start.rowIndex <= mc.end.rowIndex
                                }["SpreadsheetProvider.useCallback[modifySheetStructure]"]); // Remove invalid merges
                            }
                            toastInfo = {
                                title: "Row Deleted",
                        ...
                        case 'deleteColumn':
                            ...
                            if (sheet.mergedCells) {
                                sheet.mergedCells = sheet.mergedCells.filter({
                                    "SpreadsheetProvider.useCallback[modifySheetStructure]": (mc)=>!(mc.start.colIndex === index && mc.end.colIndex === index)
                                }["SpreadsheetProvider.useCallback[modifySheetStructure]"]).map({
                                    "SpreadsheetProvider.useCallback[modifySheetStructure]": (mc)=>{
                                        if (mc.start.colIndex > index) mc.start.colIndex--;
                                    ...
                                    "SpreadsheetProvider.useCallback[modifySheetStructure]": (mc)=>mc.start.colIndex <= mc.end.colIndex
                                }["SpreadsheetProvider.useCallback[modifySheetStructure]"]);
                            }
                            toastInfo = {
                    ...
                    for(let r = 0; r < sheet.rowCount; r++){
                        ...
                        while(sheet.cells[r].length < sheet.columnCount){
                            sheet.cells[r].push((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEmptyCell"])(r, sheet.cells[r].length));
                        }
                    ...
                    (sheet.mergedCells || []).forEach({
                        "SpreadsheetProvider.useCallback[modifySheetStructure]": (mergeRange)=>{
                            const { start: mergeStart, end: mergeEnd } = mergeRange;
                            const masterRow = Math.min(mergeStart.rowIndex, mergeEnd.rowIndex);
                            const masterCol = Math.min(mergeStart.colIndex, mergeEnd.colIndex);
                            const numRows = Math.abs(mergeEnd.rowIndex - mergeStart.rowIndex) + 1;
    ...
    const mergeSelection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[mergeSelection]": ()=>{
            if (!selectionRange || !internalSpreadsheetRef.current) return;
            const { start, end, start: { sheetId } } = selectionRange;
            if (start.rowIndex === end.rowIndex && start.colIndex === end.colIndex) {
                setTimeout({
                    "SpreadsheetProvider.useCallback[mergeSelection]": ()=>toast({
                            title: "Merge Cells",
                            description: "Select multiple cells to merge.",
                            variant: "default"
                        })
                }["SpreadsheetProvider.useCallback[mergeSelection]"], 0);
                return;
            }
            setSpreadsheetWithHistory({
                "SpreadsheetProvider.useCallback[mergeSelection]": (prev)=>{
                    if (!prev) return null;
                    const spreadsheetCopy = JSON.parse(JSON.stringify(prev));
                    const sheet = spreadsheetCopy.sheets.find({
                        "SpreadsheetProvider.useCallback[mergeSelection].sheet": (s)=>s.id === sheetId
                    }["SpreadsheetProvider.useCallback[mergeSelection].sheet"]);
                    ...
                    for(let r = minR; r <= maxR; r++){
                        for(let c = minC; c <= maxC; c++){
                            if (sheet.cells[r]?.[c]?.isMerged || sheet.mergedCells.some({
                                "SpreadsheetProvider.useCallback[mergeSelection]": (mc)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCellAddressInRange"])({
                                        sheetId,
                                        rowIndex: r,
                                        colIndex: c
                                    }, mc)
            ...
            }["SpreadsheetProvider.useCallback[mergeSelection]"], 'user_action');
        }
    }["SpreadsheetProvider.useCallback[mergeSelection]"], [
        selectionRange,
        toast,
    ...
    const unmergeSelection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[unmergeSelection]": ()=>{
            ...
            setSpreadsheetWithHistory({
                "SpreadsheetProvider.useCallback[unmergeSelection]": (prev)=>{
                    if (!prev) return null;
                    const spreadsheetCopy = JSON.parse(JSON.stringify(prev));
                    const sheet = spreadsheetCopy.sheets.find({
                        "SpreadsheetProvider.useCallback[unmergeSelection].sheet": (s)=>s.id === sheetId
                    }["SpreadsheetProvider.useCallback[unmergeSelection].sheet"]);
                    ...
                    const mergeIndex = sheet.mergedCells.findIndex({
                        "SpreadsheetProvider.useCallback[unmergeSelection].mergeIndex": (mc)=>mc.start.rowIndex === masterAddress.rowIndex && mc.start.colIndex === masterAddress.colIndex
                    }["SpreadsheetProvider.useCallback[unmergeSelection].mergeIndex"]);
                    if (mergeIndex === -1) {
                        setTimeout({
                            "SpreadsheetProvider.useCallback[unmergeSelection]": ()=>toast({
                                    title: "Unmerge Cells",
                                    description: "Active cell is not part of a merged area.",
                                    variant: "default"
                                })
                        }["SpreadsheetProvider.useCallback[unmergeSelection]"], 0);
                        return prev;
                    }
            ...
            }["SpreadsheetProvider.useCallback[unmergeSelection]"], 'user_action');
        }
    }["SpreadsheetProvider.useCallback[unmergeSelection]"], [
        activeCell,
        toast,
    ...
    const findInSheet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[findInSheet]": (searchTerm, findOptions)=>{
    ...
    }["SpreadsheetProvider.useCallback[findInSheet]"], []);
...
_s(SpreadsheetProvider, "JZtm3sFCRF5RYn6m2XFaY9LmvV0=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$spreadsheet$2f$ConditionalFormattingDialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/spreadsheet/ConditionalFormattingDialog.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/dialog.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/label.tsx [app-client] (ecmascript)");
...
function Toolbar({ spreadsheetName, theme, setTheme }) {
    ...
    const [isFindDialogOpen, setIsFindDialogOpen] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(false);
    const [findTerm, setFindTerm] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState('');
    const [findMatchCase, setFindMatchCase] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(false);
    const [findEntireCell, setFindEntireCell] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(false);
    const [findInFormulas, setFindInFormulas] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(false);
    ...
    const handleFileSelected = async (event)=>{
        ...
        reader.onload = async (e)=>{
            try {
                ...
                const saveResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveSpreadsheet"])(newSpreadsheetData);
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$menubar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenubarSubContent"], {
                                                        children: FONT_FAMILIES.map((family)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$menubar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenubarItem"], {
                                                                ...
                                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(selectedCellStyle?.fontFamily === family && "bg-accent"),
                                                                children: family
                                                            }, family, false, {
                                                                fileName: "[project]/src/components/spreadsheet/Toolbar.tsx",
                                                                lineNumber: 315,
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$menubar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenubarSubContent"], {
                                                        children: FONT_SIZES.map((size)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$menubar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenubarItem"], {
                                                                ...
                                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(selectedCellStyle?.fontSize === size && "bg-accent"),
                                                                children: size
                                                            }, size, false, {
                                                                fileName: "[project]/src/components/spreadsheet/Toolbar.tsx",
                                                                lineNumber: 323,
...
_s(Toolbar, "asDEVU1YPeK5PEQgdroHSQE1lao=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpreadsheet"],
...
function getConditionalFormatClass(cellData, address, rules, spreadsheet// Pass full spreadsheet if needed for context, not used currently
    ...
    if (rules) {
        for (const rule of rules){
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCellAddressInRange"])(address, rule.range)) {
...
function Cell({ cellData, address, onCellChange, isActive, isInSelectionRange, isFormulaHighlightTarget, onSelect, startEditing, stopEditing, isEditingThisCell, width, height, isActivelyEditingFormulaGlobal, conditionalFormatRules, rowSpan = 1, colSpan = 1, isActuallyMergedSubCell = false }) {
    ...
    if (isActuallyMergedSubCell) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(cellClasses, "border-transparent"),
            style: {
                ...appliedStyle,
                minWidth: 0,
                minHeight: 0,
    ...
    if (isEditingThisCell && !isActivelyEditingFormulaGlobal) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(cellClasses, "p-0 z-20", {
...
function Grid({ sheet }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Grid.useEffect": ()=>{
            ...
            const handleGlobalMouseUpForResize = {
                "Grid.useEffect.handleGlobalMouseUpForResize": ()=>{
    ...
    const isCellInSelection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Grid.useCallback[isCellInSelection]": (rowIndex, colIndex)=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCellAddressInRange"])({
                sheetId: sheet.id,
                rowIndex,
                colIndex
            }, selectionRange);
...
//# sourceMappingURL=src_365e13a4._.js.map