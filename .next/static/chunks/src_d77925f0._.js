(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_d77925f0._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/spreadsheet.ts [app-client] (ecmascript)"); // Renamed to avoid conflict
    ...
    if (sheetToUpdate) {
        ...
        for(let r = 0; r < sheetToUpdate.rowCount; r++){
            for(let c = 0; c < sheetToUpdate.columnCount; c++){
                ...
                if (!sheetToUpdate.cells[r][c]) sheetToUpdate.cells[r][c] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEmptyCell"])(r, c); // Ensure cell exists
...
function SpreadsheetProvider({ children }) {
    ...
    const setActiveCellAndSelection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[setActiveCellAndSelection]": (newCellAddress, isShiftKey, isDrag, endAddressOverrideForDrag)=>{
                ...
                "SpreadsheetProvider.useCallback[modifySheetStructure]": (prevSpreadsheet)=>{
                    ...
                    switch(operation){
                        ...
                        case 'insertColumn':
                            ...
                            sheet.columnWidths = sheet.columnWidths || Array(sheet.columnCount).fill(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"]);
                            if (sheet.columnWidths.length < updateColCount + 1) {
                                sheet.columnWidths = [
                                    ...sheet.columnWidths,
                                    ...Array(updateColCount + 1 - sheet.columnWidths.length).fill(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"])
                                ];
                            }
                            sheet.columnWidths.splice(index, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"]);
                            updateColCount++;
                            toastInfo = {
                        ...
                        case 'appendColumn':
                            ...
                            sheet.columnWidths = sheet.columnWidths || Array(sheet.columnCount).fill(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"]);
                            sheet.columnWidths.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COLUMN_WIDTH"]);
                            updateColCount++;
                            toastInfo = {
                                title: "Column Added",
...
_s(SpreadsheetProvider, "bMFxgd+xA79MHQDepoFUsbRWIQM=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/dialog.tsx [app-client] (ecmascript)"); // For placeholder dialogs
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
_s(Toolbar, "mM8XI2HeZB9xhfx6Ci7SHr0Rpfs=", false, function() {
    return [
...
function Cell({ cellData, address, onCellChange, isActive, isInSelectionRange, isFormulaHighlightTarget, onSelect, startEditing, stopEditing, isEditingThisCell, width, isActivelyEditingFormulaGlobal }) {
    ...
    const cellClasses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("p-1.5 border text-sm truncate min-w-[var(--default-cell-width,120px)] relative select-none outline-none", // Base styling
    {
...
_s(Cell, "ri23KeKger2HRX0I9DDtz0p+NZ0=");
_c = Cell;
var _c;
...
function Grid({ sheet }) {
    _s();
    const { spreadsheet, updateCell, activeCell, selectionRange, setActiveCellAndSelection, isActivelyEditingFormula, formulaBarApiRef } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
    ...
    const isMouseDownRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false); // To track mouse button state globally for drag
    ...
    const handleGridMouseLeave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Grid.useCallback[handleGridMouseLeave]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Grid.useEffect": ()=>{
            const handleClickOutside = {
                "Grid.useEffect.handleClickOutside": (event)=>{
...
_s(Grid, "Oy1PpuDpA24wTWLO/noVg4wp/iA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpreadsheet"]
    ];
});
...
//# sourceMappingURL=src_d77925f0._.js.map