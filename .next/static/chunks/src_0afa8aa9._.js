(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_0afa8aa9._.js", {
...
const DEFAULT_ROW_COUNT = 100; // Adjusted for stability
const DEFAULT_COLUMN_COUNT = 50; // Adjusted for stability (A to AX)
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/spreadsheet.ts [app-client] (ecmascript)"); // Added createEmptyCell and getCellId
;
...
function SpreadsheetProvider({ children }) {
    _s();
    const [internalSpreadsheet, setInternalSpreadsheet] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const setSpreadsheetWithHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[setSpreadsheetWithHistory]": (updater, actionSource)=>{
            setInternalSpreadsheet({
                "SpreadsheetProvider.useCallback[setSpreadsheetWithHistory]": (current)=>{
                    const newSpreadsheet = typeof updater === 'function' ? updater(current) : updater;
                    if (actionSource !== 'undo' && actionSource !== 'redo' && actionSource !== 'internal_no_history' && current && newSpreadsheet && JSON.stringify(current) !== JSON.stringify(newSpreadsheet)) {
    ...
    const exposedSetSpreadsheet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[exposedSetSpreadsheet]": (value)=>{
            setSpreadsheetWithHistory(value, 'internal_no_history');
        }
    ...
    const loadSpreadsheet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[loadSpreadsheet]": async (id)=>{
            ...
            if (result.success && result.data) {
                exposedSetSpreadsheet(result.data);
            } else {
                exposedSetSpreadsheet(null);
                toast({
                    title: "Error",
    ...
    const saveSpreadsheet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[saveSpreadsheet]": async ()=>{
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveSpreadsheet"])(updatedSpreadsheet);
            if (result.success) {
                exposedSetSpreadsheet(updatedSpreadsheet);
                toast({
                    title: "Success",
        ...
        "SpreadsheetProvider.useCallback[updateCell]": (sheetId, rowIndex, colIndex, newCellData)=>{
            setSpreadsheetWithHistory({
                "SpreadsheetProvider.useCallback[updateCell]": (prevSpreadsheet)=>{
                    ...
                    const newSheets = prevSpreadsheet.sheets.map({
                        "SpreadsheetProvider.useCallback[updateCell].newSheets": (sheet)=>{
                            if (sheet.id === sheetId) {
                                const newCells = sheet.cells.map({
                                    "SpreadsheetProvider.useCallback[updateCell].newSheets.newCells": (row, rIdx)=>{
                                        if (rIdx === rowIndex) {
                                            return row.map({
                                                "SpreadsheetProvider.useCallback[updateCell].newSheets.newCells": (cell, cIdx)=>{
                                                    if (cIdx === colIndex) {
                                                        let valueToDisplay = newCellData.rawValue;
                                                        let formulaString = cell.formula; // Preserve existing formula by default
                                                        if (newCellData.rawValue !== undefined) {
                                                            if (typeof newCellData.rawValue === 'string' && newCellData.rawValue.startsWith('=')) {
                                                                formulaString = newCellData.rawValue.substring(1);
                                                                valueToDisplay = newCellData.rawValue; // Display the raw formula string
                                                            } else {
                                                                formulaString = undefined; // Clear formula if it's not a formula anymore
                                                            // valueToDisplay remains newCellData.rawValue
                                                            }
                                                        } else {
                                                        ...
                                                        return {
                                                            ...cell,
                                                            ...newCellData,
                                                            rawValue: newCellData.rawValue !== undefined ? newCellData.rawValue : cell.rawValue,
                                            ...
                                            }["SpreadsheetProvider.useCallback[updateCell].newSheets.newCells"]);
                                        }
                                        return row;
                                    }
                                }["SpreadsheetProvider.useCallback[updateCell].newSheets.newCells"]);
                    ...
                    }["SpreadsheetProvider.useCallback[updateCell].newSheets"]);
                    return {
                        ...prevSpreadsheet,
                        sheets: newSheets,
                        updatedAt: Date.now()
    ...
    const updateSelectedCellStyle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[updateSelectedCellStyle]": (styleChanges)=>{
            if (!selectedCell || !internalSpreadsheet) return;
            setSpreadsheetWithHistory({
                "SpreadsheetProvider.useCallback[updateSelectedCellStyle]": (prevSpreadsheet)=>{
                    if (!prevSpreadsheet) return null;
                    const { sheetId, rowIndex, colIndex } = selectedCell;
                    const newSheets = prevSpreadsheet.sheets.map({
                        "SpreadsheetProvider.useCallback[updateSelectedCellStyle].newSheets": (sheet)=>{
                            if (sheet.id === sheetId) {
                                const newCells = sheet.cells.map({
                                    "SpreadsheetProvider.useCallback[updateSelectedCellStyle].newSheets.newCells": (row, rIdx)=>{
                                        if (rIdx === rowIndex) {
                                            return row.map({
                                                "SpreadsheetProvider.useCallback[updateSelectedCellStyle].newSheets.newCells": (cell, cIdx)=>{
                                                    if (cIdx === colIndex) {
                                                        const newStyle = {
                                                            ...cell.style || {},
                                                            ...styleChanges
                                            ...
                                            }["SpreadsheetProvider.useCallback[updateSelectedCellStyle].newSheets.newCells"]);
                                        }
                                        return row;
                                    }
                                }["SpreadsheetProvider.useCallback[updateSelectedCellStyle].newSheets.newCells"]);
                    ...
                    }["SpreadsheetProvider.useCallback[updateSelectedCellStyle].newSheets"]);
                    return {
                        ...prevSpreadsheet,
                        sheets: newSheets,
                        updatedAt: Date.now()
    ...
    const insertRow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[insertRow]": (sheetId, rowIndex)=>{
            setSpreadsheetWithHistory({
                "SpreadsheetProvider.useCallback[insertRow]": (prevSpreadsheet)=>{
                    if (!prevSpreadsheet) return null;
                    const newSheets = prevSpreadsheet.sheets.map({
                        "SpreadsheetProvider.useCallback[insertRow].newSheets": (sheet)=>{
                            if (sheet.id === sheetId) {
                                const newRow = Array.from({
                                    length: sheet.columnCount
                                }, {
                                    "SpreadsheetProvider.useCallback[insertRow].newSheets.newRow": (_, cIdx)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEmptyCell"])(rowIndex, cIdx)
                                }["SpreadsheetProvider.useCallback[insertRow].newSheets.newRow"]);
                                const updatedCells = [
                                    ...sheet.cells
                                ];
                                updatedCells.splice(rowIndex, 0, newRow);
                                // Re-ID all cells from the inserted row downwards
                                for(let r = rowIndex; r < updatedCells.length; r++){
                                    for(let c = 0; c < updatedCells[r].length; c++){
                                        updatedCells[r][c].id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCellId"])(r, c);
                                    }
                                }
                                return {
                                    ...sheet,
                    ...
                    }["SpreadsheetProvider.useCallback[insertRow].newSheets"]);
                    toast({
                        title: "Row Inserted",
                        description: `Row inserted at index ${rowIndex + 1}.`
                    });
                    return {
                        ...prevSpreadsheet,
                        sheets: newSheets,
    ...
    const deleteRow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[deleteRow]": (sheetId, rowIndex)=>{
            setSpreadsheetWithHistory({
                "SpreadsheetProvider.useCallback[deleteRow]": (prevSpreadsheet)=>{
                    if (!prevSpreadsheet) return null;
                    const newSheets = prevSpreadsheet.sheets.map({
                        "SpreadsheetProvider.useCallback[deleteRow].newSheets": (sheet)=>{
                            if (sheet.id === sheetId) {
                                if (sheet.rowCount <= 1) {
                                    toast({
                                        title: "Cannot Delete",
                                    ...
                                    return sheet; // Return original sheet
                                }
                                const updatedCells = [
                                    ...sheet.cells
                                ];
                                updatedCells.splice(rowIndex, 1);
                                // Re-ID all cells from the deleted row index downwards
                                for(let r = rowIndex; r < updatedCells.length; r++){
                                    for(let c = 0; c < updatedCells[r].length; c++){
                                        updatedCells[r][c].id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCellId"])(r, c);
                                    }
                    ...
                    }["SpreadsheetProvider.useCallback[deleteRow].newSheets"]);
                    if (prevSpreadsheet.sheets.find({
                        "SpreadsheetProvider.useCallback[deleteRow]": (s)=>s.id === sheetId
                    }["SpreadsheetProvider.useCallback[deleteRow]"])?.rowCount ?? 0 > 1) {
                        toast({
                            title: "Row Deleted",
                            description: `Row at index ${rowIndex + 1} deleted.`
                        });
                    }
                    return {
                        ...prevSpreadsheet,
    ...
    const insertColumn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[insertColumn]": (sheetId, colIndex)=>{
            setSpreadsheetWithHistory({
                "SpreadsheetProvider.useCallback[insertColumn]": (prevSpreadsheet)=>{
                    if (!prevSpreadsheet) return null;
                    const newSheets = prevSpreadsheet.sheets.map({
                        "SpreadsheetProvider.useCallback[insertColumn].newSheets": (sheet)=>{
                            if (sheet.id === sheetId) {
                                const updatedCells = sheet.cells.map({
                                    "SpreadsheetProvider.useCallback[insertColumn].newSheets.updatedCells": (row, rIdx)=>{
                                        const newRow = [
                                            ...row
                                        ];
                                        newRow.splice(colIndex, 0, (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEmptyCell"])(rIdx, colIndex));
                                        return newRow;
                                    }
                                }["SpreadsheetProvider.useCallback[insertColumn].newSheets.updatedCells"]);
                                // Re-ID all cells in all rows from the inserted column index rightwards
                                for(let r = 0; r < updatedCells.length; r++){
                                    for(let c = colIndex; c < updatedCells[r].length; c++){
                                        updatedCells[r][c].id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCellId"])(r, c);
                                    }
                                }
                                return {
                    ...
                    }["SpreadsheetProvider.useCallback[insertColumn].newSheets"]);
                    toast({
                        title: "Column Inserted",
                        description: `Column inserted at index ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCellId"])(0, colIndex).replace(/[0-9]/g, '')}.`
                    });
                    return {
                        ...prevSpreadsheet,
                        sheets: newSheets,
    ...
    const deleteColumn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[deleteColumn]": (sheetId, colIndex)=>{
            setSpreadsheetWithHistory({
                "SpreadsheetProvider.useCallback[deleteColumn]": (prevSpreadsheet)=>{
                    if (!prevSpreadsheet) return null;
                    const newSheets = prevSpreadsheet.sheets.map({
                        "SpreadsheetProvider.useCallback[deleteColumn].newSheets": (sheet)=>{
                            if (sheet.id === sheetId) {
                                ...
                                const updatedCells = sheet.cells.map({
                                    "SpreadsheetProvider.useCallback[deleteColumn].newSheets.updatedCells": (row)=>{
                                        const newRow = [
                                            ...row
                                        ];
                                ...
                                }["SpreadsheetProvider.useCallback[deleteColumn].newSheets.updatedCells"]);
                                // Re-ID all cells in all rows from the deleted column index rightwards
                                for(let r = 0; r < updatedCells.length; r++){
                                    for(let c = colIndex; c < updatedCells[r].length; c++){
                                        updatedCells[r][c].id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCellId"])(r, c);
                                    }
                    ...
                    }["SpreadsheetProvider.useCallback[deleteColumn].newSheets"]);
                    if (prevSpreadsheet.sheets.find({
                        "SpreadsheetProvider.useCallback[deleteColumn]": (s)=>s.id === sheetId
                    }["SpreadsheetProvider.useCallback[deleteColumn]"])?.columnCount ?? 0 > 1) {
                        toast({
                            title: "Column Deleted",
                            description: `Column ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCellId"])(0, colIndex).replace(/[0-9]/g, '')} deleted.`
                        });
                    }
                    return {
                        ...prevSpreadsheet,
    ...
    const undo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[undo]": ()=>{
            if (undoStack.length > 0) {
                ...
                if (internalSpreadsheet) {
                    const currentCopy = JSON.parse(JSON.stringify(internalSpreadsheet));
                    setRedoStack({
                ...
                setSpreadsheetWithHistory({
                    "SpreadsheetProvider.useCallback[undo]": ()=>previousState
    ...
    const redo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpreadsheetProvider.useCallback[redo]": ()=>{
            if (redoStack.length > 0) {
                ...
                setSpreadsheetWithHistory({
                    "SpreadsheetProvider.useCallback[redo]": ()=>nextState
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SpreadsheetContext.Provider, {
        value: {
            spreadsheet: internalSpreadsheet,
...
_s(SpreadsheetProvider, "WkncaIeIiq/RC5V0VHVuwbWA/7U=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$save$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Save$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/save.js [app-client] (ecmascript) <export default as Save>"); // Added Trash2, RowsIcon, Columns
...
;
;
function Toolbar({ spreadsheetName }) {
    _s();
    const { saveSpreadsheet, spreadsheet, setSpreadsheet, selectedCell, updateSelectedCellStyle, insertRow, deleteRow, insertColumn, deleteColumn, undo, redo, canUndo, canRedo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
    const handleNameChange = (e)=>{
        if (spreadsheet && setSpreadsheet) {
            setSpreadsheet((prev)=>prev ? {
                    ...prev,
                    name: e.target.value,
                    updatedAt: Date.now()
                } : null);
    ...
    const selectedCellStyle = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "Toolbar.useMemo[selectedCellStyle]": ()=>{
            ...
            const sheet = spreadsheet.sheets.find({
                "Toolbar.useMemo[selectedCellStyle].sheet": (s)=>s.id === selectedCell.sheetId
            }["Toolbar.useMemo[selectedCellStyle].sheet"]);
            if (!sheet) return {};
            const cell = sheet.cells[selectedCell.rowIndex]?.[selectedCell.colIndex];
            return cell?.style || {};
        }
    }["Toolbar.useMemo[selectedCellStyle]"], [
        spreadsheet,
    ...
    const handleToggleBold = ()=>{
        if (selectedCell) updateSelectedCellStyle({
    ...
    const handleInsertRow = ()=>{
        if (spreadsheet && selectedCell) {
            insertRow(selectedCell.sheetId, selectedCell.rowIndex);
        } else if (spreadsheet && spreadsheet.sheets.length > 0) {
            // If no cell selected, insert at the beginning of the active sheet
            const activeSheetId = spreadsheet.activeSheetId;
            insertRow(activeSheetId, 0);
        }
    };
    const handleDeleteRow = ()=>{
        if (spreadsheet && selectedCell) {
            deleteRow(selectedCell.sheetId, selectedCell.rowIndex);
        }
    };
    const handleInsertColumn = ()=>{
        if (spreadsheet && selectedCell) {
            insertColumn(selectedCell.sheetId, selectedCell.colIndex);
        } else if (spreadsheet && spreadsheet.sheets.length > 0) {
            const activeSheetId = spreadsheet.activeSheetId;
            insertColumn(activeSheetId, 0);
        }
    };
    const handleDeleteColumn = ()=>{
        if (spreadsheet && selectedCell) {
            deleteColumn(selectedCell.sheetId, selectedCell.colIndex);
        }
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$menubar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Menubar"], {
                        className: "border-none shadow-none p-0 h-auto ml-auto md:ml-2",
                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$menubar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenubarContent"], {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$menubar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenubarMenu"], {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$menubar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenubarTrigger"], {
                                                        className: "w-full justify-start font-normal px-2 py-1.5 text-sm relative",
                                                        disabled: !selectedCell,
                                                        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex items-center gap-1 flex-wrap mt-2 md:mt-0 border-t md:border-t-0 pt-2 md:pt-0 w-full",
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                        ...
                        disabled: !spreadsheet,
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$rows$2d$2$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__RowsIcon$3e$__["RowsIcon"], {}, void 0, false, {
                            fileName: "[project]/src/components/spreadsheet/Toolbar.tsx",
                            lineNumber: 189,
                            columnNumber: 150
                        }, this)
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                        ...
                        disabled: !spreadsheet,
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$columns$2d$2$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Columns$3e$__["Columns"], {}, void 0, false, {
                            fileName: "[project]/src/components/spreadsheet/Toolbar.tsx",
                            lineNumber: 191,
                            columnNumber: 157
                        }, this)
...
_s(Toolbar, "Cnhaym1rYcA2+oQdbewxK9yU3Io=", false, function() {
    return [
...
;
;
function Cell({ cellData, rowIndex, colIndex, onCellChange, sheetId, isSelected, onSelect }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Cell.useEffect": ()=>{
            if (!isEditing) {
                setEditValue(cellData.rawValue || '');
            }
        }
    }["Cell.useEffect"], [
        cellData.rawValue,
    ...
    const handleDoubleClick = ()=>{
        onSelect(); // Ensure cell is selected before editing
        setIsEditing(true);
    };
    const handleClick = ()=>{
        onSelect();
    ...
    const handleBlur = (e)=>{
        ...
        setIsEditing(false);
        if (String(editValue) !== String(cellData.rawValue)) {
    ...
    const handleKeyDown = (e)=>{
        ...
        // TODO: Implement navigation on Enter/Tab
    ...
    const appliedStyle = {
        ...
        color: cellStyleFromData.fontColor,
        backgroundColor: cellStyleFromData.backgroundColor,
        textAlign: cellStyleFromData.textAlign
    };
    if (isEditing) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("p-0 border relative", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                ...
                className: "w-full h-full p-1.5 box-border text-sm outline-none rounded-none border-transparent focus:ring-0 focus:border-primary",
                style: appliedStyle,
                autoFocus: true,
                "aria-label": `Edit cell ${cellData.id}`
            }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("p-1.5 border cursor-cell text-sm truncate min-w-[100px] relative", {
            "font-bold": cellData.style?.bold
        }, {
            "italic": cellData.style?.italic
        }, {
            "underline": cellData.style?.underline
        }, cellData.style?.textAlign === 'left' && "text-left", cellData.style?.textAlign === 'center' && "text-center", cellData.style?.textAlign === 'right' && "text-right"),
        style: appliedStyle,
        onClick: handleClick,
        ...
        children: [
            isSelected && !isEditing && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute inset-0 border-2 border-primary pointer-events-none rounded-[1px]"
            }, void 0, false, {
                fileName: "[project]/src/components/spreadsheet/Cell.tsx",
                lineNumber: 114,
                columnNumber: 11
...
_s(Cell, "Qp7ld9ooNXa4er9wI/DfiEFDbmM=");
_c = Cell;
var _c;
...
function Grid({ sheet }) {
    _s();
    const { updateCell, selectedCell, setSelectedCell } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
    const handleCellChange = (rowIndex, colIndex, rawValue)=>{
                ...
                children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableHead"], {
                                    className: "w-12 min-w-[3rem] p-0 text-center border sticky left-0 bg-card z-20 select-none",
                                    children: "#"
                                }, void 0, false, {
                                ...
                                Array.from({
                                    length: sheet.columnCount
                                        ...
                                        className: "min-w-[100px] p-0 text-center border select-none",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                        children: sheet.cells.map((row, rowIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableHead"], {
                                        className: "w-12 min-w-[3rem] p-0 text-center border sticky left-0 bg-card z-10 select-none",
                                        children: rowIndex + 1
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/spreadsheet/Grid.tsx",
                                        lineNumber: 48,
                                    ...
                                    row.map((cell, colIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$spreadsheet$2f$Cell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            ...
                                            sheetId: sheet.id,
                                            isSelected: !!selectedCell && selectedCell.sheetId === sheet.id && selectedCell.rowIndex === rowIndex && selectedCell.colIndex === colIndex,
...
_s(Grid, "XVwHNMay4AByp/SOKvTynkz8c20=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpreadsheet"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/button.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useSpreadsheet.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/spreadsheet.ts [app-client] (ecmascript)"); // Import getCellId
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/check.js [app-client] (ecmascript) <export default as Check>"); // Added icons
...
function FormulaBar() {
    _s();
    const { spreadsheet, selectedCell, updateCell } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpreadsheet"])();
    ...
    const [isEditingFormula, setIsEditingFormula] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // To show/hide cancel/confirm buttons
    const activeSheet = spreadsheet?.sheets.find((s)=>s.id === spreadsheet.activeSheetId);
    const cellData = selectedCell && activeSheet ? activeSheet.cells[selectedCell.rowIndex]?.[selectedCell.colIndex] : null;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FormulaBar.useEffect": ()=>{
            ...
            setIsEditingFormula(false); // Reset editing state when cell changes
        }
    }["FormulaBar.useEffect"], [
        selectedCell,
        cellData
    ...
    const handleInputChange = (e)=>{
        ...
        if (!isEditingFormula) setIsEditingFormula(true);
    };
    const submitFormula = ()=>{
        if (selectedCell && spreadsheet && activeSheet) {
            updateCell(activeSheet.id, selectedCell.rowIndex, selectedCell.colIndex, {
                rawValue: currentFormula
            });
        }
    ...
    const handleKeyDown = (e)=>{
        if (e.key === 'Enter') {
            e.preventDefault();
            submitFormula();
            // Optionally move to next cell or blur input
            e.target.blur();
        } else if (e.key === 'Escape') {
            e.preventDefault();
            cancelEdit();
    ...
    const selectedCellName = selectedCell && spreadsheet ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$spreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCellId"])(selectedCell.rowIndex, selectedCell.colIndex) : ' '; // Display space if no cell is selected
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            isEditingFormula && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                        variant: "ghost",
                        size: "icon",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Label"], {
                ...
                onClick: ()=>document.getElementById('formula-input')?.focus(),
                title: "Insert Function (Not Implemented)",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                ...
                // onBlur might conflict with button clicks, handle submission/cancellation via buttons or Enter/Escape
...
_s(FormulaBar, "aDsUui1GYzu4b405laucMixbbyw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpreadsheet"]
    ];
});
...
function SpreadsheetEditorLayout() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex flex-col h-screen bg-background_alt overflow-hidden",
        children: [
...
_s(SpreadsheetEditorLayout, "0krSd6vXzYsUy7GwiyBWO3Wg+RY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpreadsheet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpreadsheet"]
    ];
});
...
//# sourceMappingURL=src_0afa8aa9._.js.map